...
export default function Login() {
  ...
  const inputStyle = {
    ...
    borderRadius: '8px', border, background: dark ? '#12121f' : '#f8f9fc',
    color: textColor, fontSize: '0.95rem', outline: 'none', marginBottom: '1rem'
  }
    ...
    <div style={{ minHeight: '100vh', background: bg, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ background: cardBg, border, borderRadius: '16px', padding: '2.5rem', width: '400px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
        <div style={{ marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontSize: '1.4rem', fontWeight: 600, color: textColor }}>Welcome back</h2>
          <p style={{ color: '#888', fontSize: '0.9rem', marginTop: '0.25rem' }}>Sign in to your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <label style={{ display: 'block', fontSize: '0.82rem', fontWeight: 500, color: '#888', marginBottom: '0.4rem', letterSpacing: '0.03em' }}>EMAIL</label>
          ...
          <label style={{ display: 'block', fontSize: '0.82rem', fontWeight: 500, color: '#888', marginBottom: '0.4rem', letterSpacing: '0.03em' }}>PASSWORD</label>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.25rem', fontSize: '0.88rem', color: '#888' }}>Don't have an account? <Link to="/register" style={{ color: '#4361ee', fontWeight: 500 }}>Register</Link></p>
      </div>
    </div>
  )
}
